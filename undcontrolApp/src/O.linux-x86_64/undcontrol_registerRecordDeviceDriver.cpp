...
/* Generated from ../O.Common/undcontrol.dbd */
...
epicsShareExtern void (*pvar_func_register_func_my_asub_routine)(void);
...
int undcontrol_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/swilkins/Repos/undcontrol";
    ...
    (*pvar_func_asSub)();
    (*pvar_func_register_func_my_asub_routine)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"undcontrol_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    undcontrol_registerRecordDeviceDriver(*iocshPpdbbase);
}
